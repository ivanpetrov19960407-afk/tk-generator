...
async function generateSummaryReport(products, tkResults, outputDir, options = {}) {
  ...
  if (formats.includes('xlsx')) {
    ...
    [registry, pricing, materialsWs, laborWs].forEach((ws) => { ws.views = [{ state: 'frozen', ySplit: 1 }]; autoFitColumns(ws); });
...
module.exports = { generateSummaryReport, normalizeReportFormats };
